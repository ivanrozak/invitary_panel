<template>
  <div class="bg-white text-gray-600 leading-normal text-base tracking-normal">
    <!-- Hero Section -->
    <div
      class="container w-full mx-auto grid md:grid-cols-2 grid-cols-1 items-center bg-[#F8F9FC]"
    >
      <div>
        <div>Platform Undangan Digital Modern</div>
        <div>
          Sebarkan undangan digital anda hanya dalam genggaman tanpa batas waktu
          dan ruang
        </div>
      </div>
      <div class="order-first md:order-last">Image Hero</div>
    </div>
